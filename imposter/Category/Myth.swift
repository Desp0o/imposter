...
let mythologyData: [WordModel] = [
    ...
    WordModel(eng: "Centaur", geo: "კენტავრი", engHint: "Horseman", geoHint: "ცხენი"),
    WordModel(eng: "Siren", geo: "სირენა", engHint: "Song", geoHint: "სიმღერა"),
    WordModel(eng: "Pegasus", geo: "პეგასუსი", engHint: "Wings", geoHint: "ფრთები"),
    WordModel(eng: "Thor", geo: "თორი", engHint: "Hammer", geoHint: "ჩაქუჩი"),
    WordModel(eng: "Odin", geo: "ოდინი", engHint: "Allfather", geoHint: "ყველას მამა"),
